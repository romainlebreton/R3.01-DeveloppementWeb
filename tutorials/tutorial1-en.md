...
2. **[Do you remember]({{site.baseurl}}/classes/class1.html#test-de-la-page-sur-un-serveur-http)
   ...
   * Webpages must be saved in the folder **public_html** of your personal
     directory.

   * The HTTP server of the IUT will serve your webpages at the
     address
     [http://webinfo.iutmontp.univ-montp2.fr/~my_IUT_login/mypage.html](http://webinfo.iutmontp.univ-montp2.fr/~my_IUT_login/mypage.html)
